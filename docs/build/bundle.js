var app = (function () {
    ...
    /* node_modules/svelte-crossword/src/Toolbar.svelte generated by Svelte v3.38.3 */
    const file$b = "node_modules/svelte-crossword/src/Toolbar.svelte";
    ...
    /* node_modules/svelte-keyboard/src/Keyboard.svelte generated by Svelte v3.38.3 */
    const file$a = "node_modules/svelte-keyboard/src/Keyboard.svelte";
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("page0" in $$props) $$invalidate(10, page0 = $$props.page0);
    		if ("page1" in $$props) $$invalidate(11, page1 = $$props.page1);
    		if ("rows0" in $$props) $$invalidate(12, rows0 = $$props.rows0);
    		if ("rows1" in $$props) $$invalidate(13, rows1 = $$props.rows1);
    		if ("rowData0" in $$props) $$invalidate(14, rowData0 = $$props.rowData0);
    		if ("rowData1" in $$props) $$invalidate(15, rowData1 = $$props.rowData1);
    		if ("rowData" in $$props) $$invalidate(2, rowData = $$props.rowData);
    		if ("maxInRow0" in $$props) $$invalidate(16, maxInRow0 = $$props.maxInRow0);
    		if ("maxInRow1" in $$props) $$invalidate(17, maxInRow1 = $$props.maxInRow1);
    		if ("maxInRow" in $$props) $$invalidate(18, maxInRow = $$props.maxInRow);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*custom, layout*/ 96) {
    			$$invalidate(8, rawData = custom || layouts[layout]);
    		}

    		if ($$self.$$.dirty[0] & /*rawData, shifted*/ 384) {
    			$$invalidate(9, data = rawData.map(d => {
    		...
    		if ($$self.$$.dirty[0] & /*data*/ 512) {
    			$$invalidate(10, page0 = data.filter(d => !d.page));
    		}

    		if ($$self.$$.dirty[0] & /*data*/ 512) {
    			$$invalidate(11, page1 = data.filter(d => d.page));
    		}

    		if ($$self.$$.dirty[0] & /*page0*/ 1024) {
    			$$invalidate(12, rows0 = unique(page0.map(d => d.row)));
    		}

    		if ($$self.$$.dirty[0] & /*rows0*/ 4096) {
    			(rows0.sort((a, b) => a - b));
    		}

    		if ($$self.$$.dirty[0] & /*page1*/ 2048) {
    			$$invalidate(13, rows1 = unique(page1.map(d => d.row)));
    		}

    		if ($$self.$$.dirty[0] & /*rows1*/ 8192) {
    			(rows1.sort((a, b) => a - b));
    		}

    		if ($$self.$$.dirty[0] & /*rows0, page0*/ 5120) {
    			$$invalidate(14, rowData0 = rows0.map(r => page0.filter(k => k.row === r)));
    		}

    		if ($$self.$$.dirty[0] & /*rows0, page1*/ 6144) {
    			$$invalidate(15, rowData1 = rows0.map(r => page1.filter(k => k.row === r)));
    		}
    		...
    		if ($$self.$$.dirty[0] & /*rowData0*/ 16384) {
    			$$invalidate(16, maxInRow0 = Math.max(...rowData0.map(r => r.length)));
    		}

    		if ($$self.$$.dirty[0] & /*rowData1*/ 32768) {
    			$$invalidate(17, maxInRow1 = Math.max(...rowData1.map(r => r.length)));
    		}

    		if ($$self.$$.dirty[0] & /*maxInRow0, maxInRow1*/ 196608) {
    			$$invalidate(18, maxInRow = Math.max(maxInRow0, maxInRow1));
    		}

    		if ($$self.$$.dirty[0] & /*maxInRow*/ 262144) {
    ...
    class Keyboard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { custom: 5, style: 0, layout: 6 }, [-1, -1]);
    ...
    /* node_modules/svelte-crossword/src/Cell.svelte generated by Svelte v3.38.3 */

    const file$9 = "node_modules/svelte-crossword/src/Cell.svelte";
    ...
    /* node_modules/svelte-crossword/src/Puzzle.svelte generated by Svelte v3.38.3 */
    const file$8 = "node_modules/svelte-crossword/src/Puzzle.svelte";
    ...
    /* node_modules/svelte-crossword/src/Clue.svelte generated by Svelte v3.38.3 */
    const file$7 = "node_modules/svelte-crossword/src/Clue.svelte";
    ...
    /* node_modules/svelte-crossword/src/ClueList.svelte generated by Svelte v3.38.3 */
    ...
    /* node_modules/svelte-crossword/src/ClueBar.svelte generated by Svelte v3.38.3 */
    const file$5 = "node_modules/svelte-crossword/src/ClueBar.svelte";
    ...
    /* node_modules/svelte-crossword/src/Clues.svelte generated by Svelte v3.38.3 */
    const file$4 = "node_modules/svelte-crossword/src/Clues.svelte";
    ...
    /* node_modules/svelte-crossword/src/Confetti.svelte generated by Svelte v3.38.3 */
    const file$3 = "node_modules/svelte-crossword/src/Confetti.svelte";
    ...
    /* node_modules/svelte-crossword/src/CompletedMessage.svelte generated by Svelte v3.38.3 */
    ...
    /* node_modules/svelte-crossword/src/Crossword.svelte generated by Svelte v3.38.3 */
    const file$1 = "node_modules/svelte-crossword/src/Crossword.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	let clues_1_props = {
    		clues: /*clues*/ ctx[8],
    		cellIndexMap: /*cellIndexMap*/ ctx[17],
    	...
    	if (/*focusedCell*/ ctx[16] !== void 0) {
    		clues_1_props.focusedCell = /*focusedCell*/ ctx[16];
    	}
    	...
    	let puzzle_props = {
    		clues: /*clues*/ ctx[8],
    		focusedCell: /*focusedCell*/ ctx[16],
    		...
    		p: function update(ctx, dirty) {
    			if (toolbar_slot) {
    				if (toolbar_slot.p && (!current || dirty[1] & /*$$scope*/ 256)) {
    					update_slot(toolbar_slot, toolbar_slot_template, ctx, /*$$scope*/ ctx[39], !current ? [-1, -1] : dirty, get_toolbar_slot_changes, get_toolbar_slot_context);
    				}
    			} else {
    			...
    			if (dirty[0] & /*cellIndexMap*/ 131072) clues_1_changes.cellIndexMap = /*cellIndexMap*/ ctx[17];
    			...
    			if (!updating_focusedCell && dirty[0] & /*focusedCell*/ 65536) {
    				updating_focusedCell = true;
    				clues_1_changes.focusedCell = /*focusedCell*/ ctx[16];
    			...
    			if (dirty[0] & /*focusedCell*/ 65536) puzzle_changes.focusedCell = /*focusedCell*/ ctx[16];
    		...
    		p: function update(ctx, dirty) {
    			if (message_slot) {
    				if (message_slot.p && (!current || dirty[1] & /*$$scope*/ 256)) {
    					update_slot(message_slot, message_slot_template, ctx, /*$$scope*/ ctx[39], !current ? [-1, -1] : dirty, get_message_slot_changes, get_message_slot_context);
    				}
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function clues_1_focusedCell_binding(value) {
    		focusedCell = value;
    		(($$invalidate(16, focusedCell), $$invalidate(9, cells)), $$invalidate(7, focusedCellIndex));
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("cellIndexMap" in $$props) $$invalidate(17, cellIndexMap = $$props.cellIndexMap);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*cells, focusedCellIndex*/ 640) {
    			$$invalidate(16, focusedCell = cells[focusedCellIndex] || {});
    		}

    		if ($$self.$$.dirty[0] & /*cells*/ 512) {
    			$$invalidate(17, cellIndexMap = fromPairs(cells.map(cell => [cell.id, cell.index])));
    		}
    ...
    var dataInput = [
    	{
    		clue: "Next generation calls him by this name",
    		answer: "BIGMAMA",
    		direction: "down",
    		x: 5,
    		y: 3
    	...
    	{
    		clue: "Can jam with this music instrument",
    		answer: "FLUTE",
    		direction: "across",
    		x: 6,
    		y: 2
    	...
    	{
    		clue: "Frequently visited country",
    		answer: "JAPAN",
    		direction: "down",
    		x: 12,
    		y: 2
    	...
    	{
    		clue: "He gets laundry done at office for this",
    		answer: "EXERCISE",
    		direction: "down",
    		x: 10,
    		y: 0
    	...
    	{
    		clue: "Best friend and confidante",
    		answer: "RASHMI",
    		direction: "across",
    		x: 0,
    		y: 4
    	...
    	{
    		clue: "His favourite kids joke starts with this organ",
    		answer: "NOSE",
    		direction: "across",
    		x: 7,
    		y: 7
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			p = claim_element(div_nodes, "P", { class: true });
    			var p_nodes = children(p);
    			t0 = claim_text(p_nodes, "Birthday Puzzle for Mama :)");
    			p_nodes.forEach(detach_dev);
    			div_nodes.forEach(detach_dev);
